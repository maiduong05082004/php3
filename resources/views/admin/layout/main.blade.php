                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="images-admin/logo-sm.png" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="images-admin/logo-dark.png" alt="" height="17">
                                </span>
                            </a>
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="images-admin/logo-light.png" alt="" height="17">
                                </span>
                            </a>
                        </div>
                                ...
                                <div data-simplebar style="max-height: 320px;">
                                    ...
                                    <div class="notification-list">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                            <div class="d-flex">
                                                <img src="images-admin/users/avatar-2.jpg"
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                            <div class="d-flex">
                                                <img src="images-admin/users/avatar-3.jpg"
                                                    class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-grow-1">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                            <div class="d-flex">
                                                <img src="images-admin/users/avatar-5.jpg"
                                                    class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-grow-1">
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                                    ...
                                    <img src="images-admin/flags/us.svg" alt="user-image" class="me-2 rounded"
                                        height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="images-admin/flags/spain.svg" alt="user-image" class="me-2 rounded"
                                        height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="images-admin/flags/germany.svg" alt="user-image" class="me-2 rounded"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="images-admin/flags/italy.svg" alt="user-image" class="me-2 rounded"
                                        height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="images-admin/flags/russia.svg" alt="user-image" class="me-2 rounded"
                                        height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="images-admin/flags/china.svg" alt="user-image" class="me-2 rounded"
                                        height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="images-admin/flags/french.svg" alt="user-image" class="me-2 rounded"
                                        height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="images-admin/flags/ae.svg" alt="user-image" class="me-2 rounded"
                                        height="18">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                                ...
                                <div class="p-2">
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="images-admin/brands/github.png" alt="Github">
                                                <span>GitHub</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="images-admin/brands/bitbucket.png" alt="bitbucket">
                                                <span>Bitbucket</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="images-admin/brands/dribbble.png" alt="dribbble">
                                                <span>Dribbble</span>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="images-admin/brands/dropbox.png" alt="dropbox">
                                                <span>Dropbox</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="images-admin/brands/mail_chimp.png" alt="mail_chimp">
                                                <span>Mail Chimp</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="images-admin/brands/slack.png" alt="slack">
                                                <span>Slack</span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-content position-relative" id="notificationItemsTabContent">
                                    <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab"
                                        ...
                                        <div data-simplebar style="max-height: 300px;" class="pe-2">
                                            ...
                                            <div
                                                class="text-reset notification-item d-block dropdown-item position-relative">
                                                <div class="d-flex">
                                                    <img src="images-admin/users/avatar-8.jpg"
                                                        class="me-3 rounded-circle avatar-xs flex-shrink-0"
                                                        alt="user-pic">
                                                    <div class="flex-grow-1">
                                                        <a href="#!" class="stretched-link">
                                    ...
                                    <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel"
                                        ...
                                        <div data-simplebar style="max-height: 300px;" class="pe-2">
                                            ...
                                            <div class="text-reset notification-item d-block dropdown-item">
                                                <div class="d-flex">
                                                    <img src="images-admin/users/avatar-6.jpg"
                                                        class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                    <div class="flex-grow-1">
                                                        <a href="#!" class="stretched-link">
                            ...
                            <button type="button" class="btn" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="https://w7.pngwing.com/pngs/636/819/png-transparent-computer-icons-privacy-policy-admin-icon-copyright-rim-share-icon-thumbnail.png" alt="Header Avatar">
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Admin
                                            </span>
                                        <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">Logout</span>
                                    </span>
                                </span>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.categories.index') }}" class="nav-link" data-key="t-sweet-alerts">List Category</a>
                                        <a href="{{ route('admin.categories.create') }}" class="nav-link" data-key="t-sweet-alerts">Add Category</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarAdvanceUI">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                            <a href="{{ route('admin.products.index') }}" class="nav-link" data-key="t-sweet-alerts">List Product</a>
                                            <a href="{{ route('admin.products.create') }}" class="nav-link" data-key="t-sweet-alerts">Add Product</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarUsers" data-bs-toggle="collapse"
                                ...
                                <i class="ri-shield-user-fill"></i> <span data-key="t-advance-ui">User</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarUsers">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                            <a href="{{ route('admin.users.index') }}" class="nav-link" data-key="t-sweet-alerts">List Users</a>
                                            <a href="{{ route('admin.users.create') }}" class="nav-link" data-key="t-sweet-alerts">Add User</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.coupons.index') }}">
                                <i class="ri-coupon-line"></i> <span data-key="t-advance-ui">Coupons</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.banners.index') }}">
                                <i class="ri-slideshow-fill"></i> <span data-key="t-advance-ui">Banners</span>
                            </a>
                        </li>
                    </ul>
                </div>
