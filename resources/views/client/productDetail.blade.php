    ...
    function updatePrice() {
        if (selectedSize && selectedColor) {
            ...
            document.querySelectorAll('.btn-size').forEach(button => {
                if (button.dataset.size === selectedSize && button.dataset.color === selectedColor) {
                    newPrice = button.dataset.price;
                }
            });
                                ...
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="product_detail"><img src="images\products\p1.jpg"
                                                        alt=""></a>
                                            </div><!-- /.image -->
                            ...
                            <div class="item item-carousel">
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="product_detail"><img src="images\products\p2.jpg"
                                                        alt=""></a>
                                            </div><!-- /.image -->
                            ...
                            <div class="item item-carousel">
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="product_detail"><img src="images\products\p3.jpg"
                                                        alt=""></a>
                                            </div><!-- /.image -->
                            ...
                            <div class="item item-carousel">
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="product_detail"><img src="images\products\p4.jpg"
                                                        alt=""></a>
                                            </div><!-- /.image -->
                            ...
                            <div class="item item-carousel">
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="product_detail"><img src="images\blank.gif"
