...
<div class="blog-post-author-details wow fadeInUp">
	<div class="row">
		<div class="col-md-2">
			<img src="images\testimonials\member3.png" alt="Responsive image" class="img-circle img-responsive">
		</div>
		<div class="col-md-10">
			<h4>John Doe</h4>
	...
	<div class="row">
		...
		<div class="col-md-2 col-sm-2">
			<img src="images\testimonials\member1.png" alt="Responsive image" class="img-rounded img-responsive">
		</div>
		<div class="col-md-10 col-sm-10 blog-comments outer-bottom-xs">
			...
			<div class="blog-comments-responce outer-top-xs ">
				<div class="row">
					<div class="col-md-2 col-sm-2">
						<img src="images\testimonials\member2.png" alt="Responsive image" class="img-rounded img-responsive">
					</div>
					...
					<div class="col-md-2 col-sm-2">
						<img src="images\testimonials\member3.png" alt="Responsive image" class="img-rounded img-responsive">
					</div>
		...
		<div class="col-md-2 col-sm-2">
			<img src="images\testimonials\member4.png" alt="Responsive image" class="img-rounded img-responsive">
		</div>
		<div class="col-md-10 col-sm-10">
