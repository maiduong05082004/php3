      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            <li><a href="/sign_in"><i class="icon fa fa-lock"></i>Login</a></li>
          </ul>
        </div>
        <!-- /.cnt-account -->
            ...
            <ul class="dropdown-menu">
              <li>
                <div class="cart-item product-summary">
                  <div class="row">
                    <div class="col-xs-4">
                      <div class="image"> <a href="product_detail"><img src="images\cart.jpg" alt=""></a> </div>
                    </div>
                    <div class="col-xs-7">
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                    ...
                    <li>
                      <div class="yamm-content ">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive" src="images\banners\top-menu-banner.jpg" alt=""> </div>
                          <!-- /.yamm-content --> 
                        </div>
                      </div>
                    </li>
                ...
                <li class="dropdown hidden-sm"> <a href="/category">Health & Beauty <span class="menu-label new-menu hidden-xs">new</span> </a> </li>
                {{-- <li class="dropdown hidden-sm"> <a href="category.html">Watches</a> </li> --}}
                <li class="dropdown"> <a href="/category">Shoes</a> </li>
                <li class="dropdown"> <a href="/category">Kids & Girls</a> </li>
